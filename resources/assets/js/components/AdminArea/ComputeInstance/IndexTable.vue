<template>
    <div class="ui grid">
        <div class="ten wide column">
            ...
            <div ref="statusSelect" class="ui mini selection dropdown">
                <i class="dropdown icon"></i>
                <div class="text">{{ statusText }}</div>
                <div class="menu">
                    <div class="item" v-on:click="changeStatus(null)" :data-value="null">所有</div>
                    <div class="item" v-on:click="changeStatus(1)" :data-value="1">创建中</div>
                    <div class="item" v-on:click="changeStatus(5)" :data-value="5">已锁定</div>
                    <div class="item" v-on:click="changeStatus(6)" :data-value="6">销毁中</div>
                    <div class="item" v-on:click="changeStatus(8)" :data-value="8">创建失败</div>
                    <div class="item" v-on:click="changeStatus(8)" :data-value="9">销毁失败</div>
                </div>
            </div>
            ...
            >
                <tr v-for="(instance, index) in items">
                    ...
                    <td v-if="selectedColumns.name" class="td-flex">
                        ...
                        <router-link :to="{name: 'admin.computeInstances.dashboard', params: {id: instance.id}}" style="display: inline-block;">
                    ...
                    <user-column v-if="selectedColumns.user" :entry="instance"></user-column>
...
<script>
    ...
    import StatusLabel from "./../../ClientArea/ComputeInstance/StatusLabel";
    import InstanceOperation from "./Column/OperationColumn";
    import PowerStatusIconLabel from "../../ComputeInstance/PowerStatusIconLabel";
    import PowerAction from "./../../ClientArea/ComputeInstance/PowerAction";
    ...
    export default {
        name: "IndexTable",
        components: {UserColumn, PowerStatusIconLabel, InstanceOperation, StatusLabel},
        ...
        data: function () {
            return {
                ...
                indexRouteName: "admin.computeInstances.index",
                massDestroyRouteName: "admin.computeInstances.massDestroy",
        ...
        created: function () {
            ...
            if (query.hasOwnProperty("status")) {
                if (query.status === "1" || query.status === "5" || query.status === "6" || query.status === "8") {
        ...
        methods: {
            ...
            massDestroy: function () {
                ...
                axios.post(route("admin.computeInstances.operation.massDestroy"), {
