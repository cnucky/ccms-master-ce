    ...
    <div class="ui grid">
        ...
        <div class="sixteen wide column">
            ...
            <sortable-table
                    ...
                    :operable="true"
                    operation-component="trade-operation-column"
...
<script>
    ...
    Vue.component("trade-operation-column", require("./TradeOperationColumn"));
    Vue.component("trade-index-amount-column", require("./Column/AmountColumn"));
    Vue.component("trade-index-payment-module-column", require("./Column/PaymentModuleColumn"));
    Vue.component("trade-index-status-column", require("./../../PaymentTrade/StatusColumn"));

    export default {
        name: "PaymentTradeIndex",
        ...
        data: function () {
            return {
                ...
                columnComponents: {
                    ...
                    basic_payment_module: "trade-index-payment-module-column",
                    fee_in_default_currency: "trade-index-amount-column",
                    status: "trade-index-status-column",
                    paid_at: "local-time-column",
                    created_at: "local-time-column",
                },

                indexRouteName: "billing.paymentTrades.index",
