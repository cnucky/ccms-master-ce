<template>
    <navigation-container>
        <icon-back-button></icon-back-button>

        <authenticated-user-quick-action></authenticated-user-quick-action>


        <authenticated-user-sidebar></authenticated-user-sidebar>
    </navigation-container>
</template>

<script>
    import IconBackButton from "../SemanticUI/IconBackButton";
    export default {
        name: "Navigation",
        components: {IconBackButton},
        mounted: function () {
            this.$nextTick(function () {
                // $("#sidebar .menu > li.dropdown").has("li.active").addClass("active open");
                $("#sidebar .menu > li.dropdown").has("li.active").addClass("open");
                ...
                var widthLess1024 = function(){
                    if ($(window).width() < 1280) {
                        ...
                        if ($('#sidebar').hasClass('collapsed')) {
                            $('#router-view').animate({left: "210px",paddingLeft: "280px"},150);
                        } else {
                            $('#router-view').animate({paddingLeft: "280px"},150);
                        };
                    }
                ...
                $('#sidebar .sidebar-toggle').on('click', function(e) {
                    e.preventDefault();
                ...
                $('#navigation .dropdown-menu').on('click', function (e) {
                    e.stopPropagation();
                });
                    ...
                    if (!isMobile.any()) {
                        if ($('#sidebar').hasClass('collapsed')) {
                            ...
                            if ($(window).width() < 1024) {
                                ...
                                //if width is not less than 1024px give padding 280px to content
                                $('#router-view').animate({paddingLeft: "280px"},150)
                            }
                        }
                    } else {
                        if ($('#sidebar').hasClass('collapsed')) {
                            ...
                            $('#router-view').css({paddingLeft: "280px", display: 'block'})
                        }
                    }
        ...
        destroyed: function () {
            $(window).off("resize");
            $("#router-view").css("padding-left", "0");
        },
    }
</script>
