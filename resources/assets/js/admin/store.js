...
export default new Vuex.Store({
    state: {
        ...
        permissions: userInformation.permissions,
    ...
    getters: {
        ...
        countryPhoneCode: (state, getters) => (countryCode) => {
            return state.countryPhoneCodeMap[countryCode];
        },
        hasPermission: (state) => (permission) => {
            return state.permissions.hasOwnProperty(permission);
        }
    },
    mutations: {
        update: function (state) {
            axios
                .get(route('admin.currentUser'))
                .then((response) => {
