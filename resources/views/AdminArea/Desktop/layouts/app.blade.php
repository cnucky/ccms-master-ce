...
<body>
    <div id="app">
        ...
        <admin-guest-navigation v-else></admin-guest-navigation>
    ...
    <script type="text/javascript">
        var userInformation = @json(\App\Utils\UserInformation::adminUserInformation());
    </script>
    ...
    @else
        <script src="{{ asset('static/admin/js/ccms.js') }}"></script>
    @endif
